/*
  ...
  1. New Columns
    - Add position column for ordering within status groups
    - Add implementation_status column with proper constraints

  2. Security
    - Enable RLS on features table
    - Add comprehensive RLS policies for feature management
    - Add position management trigger

  3. Changes
    - Update existing features with default positions
