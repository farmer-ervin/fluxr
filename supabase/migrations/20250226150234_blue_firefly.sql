-- Drop existing kanban cards policy
DROP POLICY IF EXISTS "Users can manage own kanban cards" ON kanban_cards;

-- Create improved kanban cards policy that handles feature relationships
...
-- Drop existing features policies to recreate them
